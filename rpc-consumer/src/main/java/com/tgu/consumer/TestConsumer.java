...
public class TestConsumer {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 1; i++) {
            executor.submit(() -> {
                User u = proxy.getUserByUserId(1);
                if (u != null) {
                    log.info("✅ 请求成功: {}", u);
                } else {
